                        ...
                        <h2>
                            <div class="item">
                                <a href="index.php" class="image">
                                    <img data-echo="brandsimage/logo.png" src="brandsimage/logo-01.png"
                                        style="height: 92px">
                            ...
                            <div class="cart-item product-summary">
                                <div class="row">
                                    <div class="col-xs-4">
                                        <div class="image">
                                            <a href="detail.html"><img
                                                    src="admin/productimages/<?php echo $row['productImage']; ?>"
                                    ...
                                    <div class="col-xs-7">
                                        ...
                                        <div class="price">
                                            Tk.<?php echo ($row['productPrice'] + $row['shippingCharge']); ?>*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?>
                                        </div>
                            ...
                            <div class="clearfix cart-total">
                                <div class="pull-right">
                                    <span class="text">Total :</span><span
                                        class='price'>Tk.<?php echo $_SESSION['tp'] = "$totalprice" . ".00"; ?></span>
                                </div>
